    ...
    "inputs": [
      {
        "name": "p",
        "type": "tuple",
        "internalType": "struct DuelNative.DeployParams",
        "components": [
          {
            "name": "initialOwner",
            "type": "address",
    ...
    "inputs": [
      {
        "name": "slot",
        "type": "uint8",
        "internalType": "enum DuelNative.Wire"
      },
      {
        "name": "target",
        "type": "address",
    ...
    "inputs": [
      {
        "name": "r",
        "type": "tuple",
        "internalType": "struct DuelNative.DuelResult",
        "components": [
          {
            "name": "tokenA",
            "type": "uint256",
